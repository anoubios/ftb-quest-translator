...
public class Config {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> TARGET_LANGUAGE = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_CACHING = BUILDER
    ...
    public static final ForgeConfigSpec.EnumValue<TranslationProvider> TRANSLATION_PROVIDER = BUILDER
            .comment("Translation API provider.",
                     "AUTO - Automatic fallback: Google -> MyMemory (recommended)",
                     "GOOGLE - Google Translate with DoH bypass (free, no key needed)",
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_TRANSLATING_ANIMATION = BUILDER
            .comment("Enable the yellow wave animation while a quest is being translated.")
            .define("enableTranslatingAnimation", true);

    public static final ForgeConfigSpec.BooleanValue ENABLE_TRANSLATED_ANIMATION = BUILDER
            .comment("Enable the green wave animation when a quest has been translated.")
            .define("enableTranslatedAnimation", true);

    public static final ForgeConfigSpec.BooleanValue ENABLE_LARGE_TEXT_WARNING = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> LARGE_TEXT_THRESHOLD = BUILDER
            .comment("The character count threshold used to trigger the large text warning.")
            .define("largeTextThreshold", 2000);

    public static final ForgeConfigSpec.BooleanValue ENABLE_TTS_LOADING_ANIMATION = BUILDER
            .comment("Enable the animated yellow rings while TTS is loading.")
            .define("enableTtsLoadingAnimation", true);

    public static final ForgeConfigSpec.BooleanValue ENABLE_TTS_PLAYING_ANIMATION = BUILDER
            .comment("Enable the animated reading rings while TTS is playing.")
            .define("enableTtsPlayingAnimation", true);

    public static final ForgeConfigSpec.BooleanValue ENABLE_TRANSLATE_BUTTON = BUILDER
            .comment("Enable the quest translate button.")
            .define("enableTranslateButton", true);

    public static final ForgeConfigSpec.BooleanValue ENABLE_TTS_BUTTON = BUILDER
            .comment("Enable the text-to-speech button.")
            .define("enableTtsButton", true);

    public static final ForgeConfigSpec.ConfigValue<Integer> TRANSLATION_ANIMATION_DURATION = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<Double> TTS_PITCH = BUILDER
            .comment("Pitch factor for TTS voice (e.g. 1.0 is normal). MIN: 0.1, MAX: 5.0")
            .defineInRange("ttsPitch", 1.0, 0.1, 5.0);

    public static final ForgeConfigSpec.ConfigValue<Double> TTS_RATE = BUILDER
